        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="row layout-top-spacing widget-statistic">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div id="project-partials-widget-project-amount-percent" wire:ignore>
                        <livewire:admin.project.partials.widget-project-amount-percent lazy />
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div id="project-partials-widget-project-volunteer-percent" wire:ignore>
                        <livewire:admin.project.partials.widget-project-volunteer-percent lazy />
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div id="project-partials-widget-project-time-percent" wire:ignore>
            ...
            <div class="row widget-statistic">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                    <div id="project-partials-widget-projects-dontions-sum-amount" wire:ignore>
                        <livewire:admin.project.partials.widget-projects-dontions-sum-amount lazy />
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                    <div id="project-partials-widget-projects-donations-count" wire:ignore>
                        <livewire:admin.project.partials.widget-projects-donations-count lazy />
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 layout-spacing">
                    <div id="project-partials-widget-projects-volunteers-count" wire:ignore>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                    ...
                    >
                        ...
                        <x-slot:customScript>
                            ...
                            "ordering": false,
                            "ajax": {
                            "url": "{{ route('member.dashboard.projects') }}",
                                "data": function(d) {
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                    ...
                    >
                        ...
                        <x-slot:customScript>
                            ...
                            "ordering": false,
                            "ajax": {
                            "url": "{{ route('member.dashboard.donations') }}",
                                "data": function(d) {
                                    let searchParams = new URLSearchParams(window.location.search);
                                    drawDT = d.draw;
                                    d.limit = d.length;
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                    ...
                    >
                        ...
                        <x-slot:customScript>
                            ...
                            "ordering": false,
                            "ajax": {
                            "url": "{{ route('member.dashboard.volunteers') }}",
                                "data": function(d) {
                                    let searchParams = new URLSearchParams(window.location.search);
                                    drawDT = d.draw;
                                    d.limit = d.length;
