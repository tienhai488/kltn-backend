...
class WidgetCommonProjectsVolunteersCount extends Component
{
    ...
    public $productsVolunteersCount;
    public $loaded = false;
    ...
    {
        return view('livewire.admin.dashboard.partials.widget-common-projects-volunteers-count');
    }
}
