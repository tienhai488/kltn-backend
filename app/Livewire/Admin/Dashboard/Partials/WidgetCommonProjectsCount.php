...
class WidgetCommonProjectsCount extends Component
{
    ...
    public function loadData()
    {
        ...
        $this->projectsCount = $this->projectRepository->getProjectData($conditions)->count();
    }
    ...
    {
        return view('livewire.admin.dashboard.partials.widget-common-projects-count');
    }
}
