...
class WidgetUserDonationsSumAmount extends Component
{
    ...
    {
        if (!$this->loaded && $this->belongToUserId) {
            return;
        }
        $conditions = [
            'search' => $this->search,
        ...
        $this->donationsSumAmount = customFormatPrice($this->donationRepository->getDonationData($conditions)->sum('amount'), ' VNĐ');
    }
    ...
    {
        return view('livewire.admin.dashboard.partials.widget-user-donations-sum-amount');
    }
}
