...
class WidgetCommonProjectsDonationsCount extends Component
{
    ...
    public function loadData()
    {
        ...
        $this->projectsDonationsCount = $this->projectRepository->getProjectData($conditions)->sum('projects_donations_with_paid_count');
    }
    ...
    {
        return view('livewire.admin.dashboard.partials.widget-common-projects-donations-count');
    }
}
