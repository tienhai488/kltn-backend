...
class ProjectResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'volunteer_quantity' => customFormatPrice($this->volunteer_quantity, ''),
            'volunteers_count' => $this->volunteers_count,
            'donations_count' => $this->donations_count,
            'volunteers_without_canceled_count' => customFormatPrice($this->volunteers_without_canceled_count, '') ?? 0,
