...
use App\Http\Resources\Member\Volunteer\ExportVolunteerResource;
...
class VolunteerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('member.volunteer.index', compact('users', 'projects', 'departments'));
    }
    ...
    public function show(Volunteer $volunteer)
    {
        ...
        return view('member.volunteer.show', compact('volunteer'));
    }
